...
public class LightBehavior : MonoBehaviour {
    ...
    void Start () {
        ...
        num = factory.getNum();
        LineRendererGameObject = factory.getObject(num - 1);
	...
	void Update () {
            ...
            // 清除前面的点
            point.Clear();
            currentDirection = factory.getDirection(num - 1);
            currentSource = factory.getPosition(num - 1);
            RaycastHit hit;
            point.Add(currentSource);
        ...
        while (!end)
        {
            ...
            {
                point.Add(currentSource + 100 * currentDirection);
                end = true;
                factory.remove(num);
            }
        }
